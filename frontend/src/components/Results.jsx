const Results = ({ showResponse, showPriority }) => {
  ...
  return (
    <div className="mt-5">
      <h2 className="lg:text-xl font-semibold mb-4 border-b border-[#ced4da] dark:border-white/6 pb-2">Results</h2>

      <div className="overflow-x-auto">
        <table className="w-full border-collapse text-sm rounded-md">
          <thead className="bg-gray-50 dark:bg-white/6">
            <tr>
              <th className="p-3 border border-[#ced4da] dark:border-white/6 sm:text-sm md:text-lg">PID</th>
              <th className="p-3 border border-[#ced4da] dark:border-white/6 sm:text-sm md:text-lg">Arrival Time</th>
              <th className="p-3 border border-[#ced4da] dark:border-white/6 sm:text-sm md:text-lg">Burst Time</th>
              {showPriority && (
                <th className="p-3 border border-[#ced4da] dark:border-white/6 sm:text-sm md:text-lg">Priority</th>
              )}
              <th className="p-3 border border-[#ced4da] dark:border-white/6 sm:text-sm md:text-lg">Waiting Time</th>
              <th className="p-3 border border-[#ced4da] dark:border-white/6 sm:text-sm md:text-lg">Turn-around Time</th>
            </tr>
          </thead>
          <tbody className="sm:text-sm md:text-lg">
      ...
      <div className="mt-4 p-4 bg-gray-50 dark:bg-white/6 rounded-md shadow-inner lg:text-lg">
